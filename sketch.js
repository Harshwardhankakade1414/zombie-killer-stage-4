...
if(gameState == "lost"){
  ...
  textSize(50)
  text("You have been attacked by the zombies",200,470);
...
//destroy zombie and player and display a message in gameState "won"
  ...
  textSize(50);
  text("You killed all the zombies",250,470);
  zombieGroup.destroyEach();
  player.destroy();
...
//destroy zombie, player and bullets and display a message in gameState "bullet"
  ...
  if(lives>0){
    ...
    text("you killed all the zombies",300,470);
    zombieGroup.destroyEach();
    player.destroy();
    bulletGroup.destroyEach();
  }
...
function enemy(){
  if(frameCount%250===0){
    ...
    zombie = createSprite(displayWidth-200,random(100,500),40,40)
